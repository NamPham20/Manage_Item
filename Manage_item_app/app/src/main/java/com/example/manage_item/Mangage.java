...
import com.example.manage_item.Fragment.ProhibitedItemsFargment;
import com.example.manage_item.Fragment.UserlistFargment;
import com.google.android.material.navigation.NavigationView;

public class Mangage extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mangage);
       ...
       // navigationView.getMenu().findItem(R.id.nv_home).setChecked(true);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
      ...
      if(id == R.id.nv_home){
          ...
          if(currentFragment != FRAGMENT_HISTORY){
              Intent intent1 = new Intent(Mangage.this, HistoryDetect.class);
              Bundle bundle =new Bundle();
          ...
          if(currentFragment != FRAGMENT_CHANGE_PASSWORD){
              Intent intent1 = new Intent(Mangage.this, ChangePassword.class);
              Bundle bundle =new Bundle();
